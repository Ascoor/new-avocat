...
const CallToAction: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-primary py-24 text-center text-text-inverse" aria-labelledby="cta-heading">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <h2 id="cta-heading" className="mb-6 text-3xl font-bold md:text-5xl animate-fadeInDown">
          {t("landing.cta.title")}
        </h2>
